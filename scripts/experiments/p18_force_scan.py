#!/usr/bin/env python3
"""P-18 force-provenance scan: the RUNS forces in p18_alf_waveguide.py
...
Deterministic, stdlib only. Output: p18_force_scan.json."""
import json
...
from p18_alf_waveguide import simulate, lock_stats, RUNS  # noqa: E402
...
def main():
    ...
    (HERE / "p18_force_scan.json").write_text(json.dumps(out, indent=1) + "\n")
