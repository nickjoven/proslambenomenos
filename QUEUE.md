...
claims/alf-period-lattice.yml + notes/p19_alf_lattice.md +
scripts/experiments/p19_alf_waveguide.py +
scripts/verify/p19_alf_lattice.py (two mutants). Registered as P-19.
...
field half of the P-19 falsifier, a separate future claim if run.
