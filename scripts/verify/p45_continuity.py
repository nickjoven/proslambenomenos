...
through D); (4) the own-integrator ladder: global and per-site
sup-defects decrease monotonically with ratios >= 2^0.5.
...
KNOWN = {"current-blind", "sink-blind", "gauge-blind"}
...
def trajectory(dt, twisted, t_total=60.0, t_ramp=20.0):
