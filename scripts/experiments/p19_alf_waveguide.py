#!/usr/bin/env python3
"""P-19 experiment: ALF locked periods on a bowed-string waveguide lie
...
Outputs scripts/experiments/p19_results.json:
...
def main():
    ...
    path = Path(__file__).with_name("p19_results.json")
