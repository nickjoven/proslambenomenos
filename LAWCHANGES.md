...
## LAW-50 — 2026-09-01 — the P-44 falsifier pinned
direction: strengthen
why: scripts/verify/p44_gramian_chain.py is new gate-covered
evidence (closed-form 2x2 eigenvalues, a literal fixed instance,
its own scalar-mass quadrature, the pinned extremal family;
mutants sup-blind and mass-blind - the legitimacy conditions
|f| <= 1 and mass 2 are each load-bearing, breaking the chain
deterministically on the extremal instance). New covered files
require a fresh pin of the full covered set; nothing else changes
and no gate semantics move.
hashes:
  1b8ab111bb43eb17a25a822468e8f978c4883f67b9ea3b15bc5b85d0b499f7b4  catalog/_common.py
  ...
  ff7d158cc90ea0cabcc6fbfc5f2529eff1078750ff8bd53e7d4db037b10d6ae8  scripts/verify/p42_same_data.py
  36b6b2d4a1a3dff82b291ba06dba557936cd16f0452d377d511f25a5783ba7af  scripts/verify/p43_shadow_body.py
  3d01f7ef88efef16d5ef26a5f5bdef95cd0efc66a62273a974122141fea6824f  scripts/verify/p44_gramian_chain.py
  4355a643f81ab69f9d7f92331355fe37964c445e64873a49b5461c1eefe391e6  scripts/verify/p6_circulant_small.py
  b60ad77d615e353171739472bafbda552f4d1f60f34dd504812c7383a60f7df5  scripts/verify/p7_golden_flux.py
  97bde79c88fc71a1f10af692c7acc4f980a7e97a6f9b1887bf55c5900485a1e5  scripts/verify/q1_saddle_node.py
  9817e5aa93f80e96db3d9429fc778498fd3249f72c1fa17332d21006ff59820f  scripts/verify/q_j_structure.py
...
## LAW-51 — 2026-09-01 — the P-45 falsifier pinned
direction: strengthen
why: scripts/verify/p45_continuity.py is new gate-covered
evidence (forward-mode dual-number derivatives of the site
energy, own seed and ring size, own velocity-Verlet trajectory;
mutants current-blind, sink-blind, gauge-blind - each verified
failing in the derive layer before pinning, the first invisible
to the global balance and the third to the control ring, which
is why the per-site and seam checks exist). New covered files
require a fresh pin of the full covered set; nothing else changes
and no gate semantics move.
hashes:
  1b8ab111bb43eb17a25a822468e8f978c4883f67b9ea3b15bc5b85d0b499f7b4  catalog/_common.py
  ...
  36b6b2d4a1a3dff82b291ba06dba557936cd16f0452d377d511f25a5783ba7af  scripts/verify/p43_shadow_body.py
  3d01f7ef88efef16d5ef26a5f5bdef95cd0efc66a62273a974122141fea6824f  scripts/verify/p44_gramian_chain.py
  5147fbe779534528d9a66be01efdc95de857f1fe3e319a6b131cd3b23e351ebd  scripts/verify/p45_continuity.py
  4355a643f81ab69f9d7f92331355fe37964c445e64873a49b5461c1eefe391e6  scripts/verify/p6_circulant_small.py
  b60ad77d615e353171739472bafbda552f4d1f60f34dd504812c7383a60f7df5  scripts/verify/p7_golden_flux.py
  97bde79c88fc71a1f10af692c7acc4f980a7e97a6f9b1887bf55c5900485a1e5  scripts/verify/q1_saddle_node.py
  9817e5aa93f80e96db3d9429fc778498fd3249f72c1fa17332d21006ff59820f  scripts/verify/q_j_structure.py
...
## LAW-52 — 2026-09-02 — the P-46 falsifier pinned
direction: strengthen
why: scripts/verify/p46_aftermath.py is new gate-covered
evidence (velocity-Verlet with the damping at the old velocity,
own event detector and bond-phase lock-in, the off-band response
by direct complex tridiagonal solve rather than the closed-form
root; mutants bond-blind, rate-blind, band-blind - each verified
failing, the rate-blind one only after its check points moved to
2/gamma and 3/gamma where the two rates differ by more than the
derived bound). New covered files require a fresh pin of the full
covered set; nothing else changes and no gate semantics move.
hashes:
  1b8ab111bb43eb17a25a822468e8f978c4883f67b9ea3b15bc5b85d0b499f7b4  catalog/_common.py
  fb7ed34eb62f641c0a93a98fe0e8a484b61cab8c38a0a76e8c61ea6246468ba9  kernels/__init__.py
  ...
  3d01f7ef88efef16d5ef26a5f5bdef95cd0efc66a62273a974122141fea6824f  scripts/verify/p44_gramian_chain.py
  5147fbe779534528d9a66be01efdc95de857f1fe3e319a6b131cd3b23e351ebd  scripts/verify/p45_continuity.py
  7dc02c1c2a24e1d06e7de9a3ead7245c13c27f3808b7c4dd14edb75fe1390702  scripts/verify/p46_aftermath.py
  4355a643f81ab69f9d7f92331355fe37964c445e64873a49b5461c1eefe391e6  scripts/verify/p6_circulant_small.py
  b60ad77d615e353171739472bafbda552f4d1f60f34dd504812c7383a60f7df5  scripts/verify/p7_golden_flux.py
  97bde79c88fc71a1f10af692c7acc4f980a7e97a6f9b1887bf55c5900485a1e5  scripts/verify/q1_saddle_node.py
  9817e5aa93f80e96db3d9429fc778498fd3249f72c1fa17332d21006ff59820f  scripts/verify/q_j_structure.py
...
## LAW-53 — 2026-09-02 — the P-47 falsifier pinned
direction: strengthen
why: scripts/verify/p47_half_sector.py is new gate-covered
evidence (the shared density by direct N-fold convolution rather
than the characteristic-function integral, its own velocity-Verlet
Langevin ring with the noise kick at the half step, an equilibrium
anchor, a floor cell at T = 0.2 and a quench at N = 16; mutants
shift-blind and count-blind, each verified failing - a first
loosened-check mutant that could not fail on correct data was
discarded per L-8). New covered files require a fresh pin of the
full covered set; nothing else changes and no gate semantics move.
hashes:
  1b8ab111bb43eb17a25a822468e8f978c4883f67b9ea3b15bc5b85d0b499f7b4  catalog/_common.py
  fb7ed34eb62f641c0a93a98fe0e8a484b61cab8c38a0a76e8c61ea6246468ba9  kernels/__init__.py
  02f3a2118b28aeaea0ead99be1cfde6ecd1f6ebdbf08e61cb6c6dc342db02a36  kernels/causet.py
  ...
  5147fbe779534528d9a66be01efdc95de857f1fe3e319a6b131cd3b23e351ebd  scripts/verify/p45_continuity.py
  7dc02c1c2a24e1d06e7de9a3ead7245c13c27f3808b7c4dd14edb75fe1390702  scripts/verify/p46_aftermath.py
  b9f7d4a0faacf05ffbfd92e07da1fdab2bec7e8a3286342d47ef6cd84acfb9f2  scripts/verify/p47_half_sector.py
  4355a643f81ab69f9d7f92331355fe37964c445e64873a49b5461c1eefe391e6  scripts/verify/p6_circulant_small.py
  b60ad77d615e353171739472bafbda552f4d1f60f34dd504812c7383a60f7df5  scripts/verify/p7_golden_flux.py
  97bde79c88fc71a1f10af692c7acc4f980a7e97a6f9b1887bf55c5900485a1e5  scripts/verify/q1_saddle_node.py
  9817e5aa93f80e96db3d9429fc778498fd3249f72c1fa17332d21006ff59820f  scripts/verify/q_j_structure.py
...
## LAW-54 — 2026-09-02 — the P-45 falsifier gains the through-slip order test
direction: strengthen
why: scripts/verify/p45_continuity.py changes on the 2026-09-02
audit (R-45a). The smooth ladder cells move below both N = 48
folds (F_SMOOTH = 1.85; the LAW-51 pin ran the twisted cell at
F = 1.97 above its fold 1.9497, so it slipped at t = 29 of 60
with the rotor at 47 and passed only because the check is
one-sided - undocumented until the audit). A fifth check adds
the order test the claim's clause (2) registers and had no
reimplementation behind: an own Euler-Cromer integrator in the
P-36 order with force-times-displacement bookkeeping, on a
twisted N = 16 ring one step above its own fold, through the
slip to event + 20 on dt = 0.001 / 0.0005 / 0.00025, both
sup-defects inside the two-sided band [2^0.5, 2^1.5] (reads
2.002 / 2.001 global and per-site, the event at 28.0 on every
rung). A fourth mutant, share-blind (each bond assigned wholly to
its left site in the ladder's site energy), is invisible to the
residual checks and the global ladder and is killed by the
per-site slip ladder; the three older mutants verified failing
unchanged. Runtime 12 s. Covered set re-pinned; no gate
semantics move.
hashes:
  1b8ab111bb43eb17a25a822468e8f978c4883f67b9ea3b15bc5b85d0b499f7b4  catalog/_common.py
  fb7ed34eb62f641c0a93a98fe0e8a484b61cab8c38a0a76e8c61ea6246468ba9  kernels/__init__.py
  ...
  36b6b2d4a1a3dff82b291ba06dba557936cd16f0452d377d511f25a5783ba7af  scripts/verify/p43_shadow_body.py
  3d01f7ef88efef16d5ef26a5f5bdef95cd0efc66a62273a974122141fea6824f  scripts/verify/p44_gramian_chain.py
  10e39dbabf2af255358004754f74dbcef3df5eca17aca706326e87e9a84a15b3  scripts/verify/p45_continuity.py
  7dc02c1c2a24e1d06e7de9a3ead7245c13c27f3808b7c4dd14edb75fe1390702  scripts/verify/p46_aftermath.py
  b9f7d4a0faacf05ffbfd92e07da1fdab2bec7e8a3286342d47ef6cd84acfb9f2  scripts/verify/p47_half_sector.py
  4355a643f81ab69f9d7f92331355fe37964c445e64873a49b5461c1eefe391e6  scripts/verify/p6_circulant_small.py
  b60ad77d615e353171739472bafbda552f4d1f60f34dd504812c7383a60f7df5  scripts/verify/p7_golden_flux.py
...
## LAW-55 — 2026-09-02 — the P-48 falsifier pinned
direction: strengthen
why: scripts/verify/p48_kappa.py is new gate-covered evidence: an
own Euler-Cromer step of the stiffness-kappa ring against the
scaled unit-stiffness step at 2000 random states for kappa in
{0.5, 2, 3} (residuals at 0.04 to 0.05 of the 32 eps floor); an
own trajectory through the slip at kappa = 3 (a non-dyadic root)
with identical event steps and the phase deviation within the
derived bound; an own N = 16 ring at gamma = 0.5 with both
lock-in references and a direct complex tridiagonal solve for the
tail band. Mutants kappa-blind (gamma/kappa) and load-blind
(f/sqrt kappa), each verified failing; a reference-blind mutant
was tried at N = 16 and 32 and did not break (the mixing it
targets is a long-ring effect), recorded in the docstring, not
pinned (L-8, L-13). Runtime 3 s. New covered file requires a
fresh pin of the full covered set; nothing else changes and no
gate semantics move.
hashes:
  1b8ab111bb43eb17a25a822468e8f978c4883f67b9ea3b15bc5b85d0b499f7b4  catalog/_common.py
  fb7ed34eb62f641c0a93a98fe0e8a484b61cab8c38a0a76e8c61ea6246468ba9  kernels/__init__.py
  ...
  7dc02c1c2a24e1d06e7de9a3ead7245c13c27f3808b7c4dd14edb75fe1390702  scripts/verify/p46_aftermath.py
  b9f7d4a0faacf05ffbfd92e07da1fdab2bec7e8a3286342d47ef6cd84acfb9f2  scripts/verify/p47_half_sector.py
  6dd0e268e0816306ff6800cac29169c8159fa43e43a58db13372a05168706cd0  scripts/verify/p48_kappa.py
  4355a643f81ab69f9d7f92331355fe37964c445e64873a49b5461c1eefe391e6  scripts/verify/p6_circulant_small.py
  b60ad77d615e353171739472bafbda552f4d1f60f34dd504812c7383a60f7df5  scripts/verify/p7_golden_flux.py
  97bde79c88fc71a1f10af692c7acc4f980a7e97a6f9b1887bf55c5900485a1e5  scripts/verify/q1_saddle_node.py
  9817e5aa93f80e96db3d9429fc778498fd3249f72c1fa17332d21006ff59820f  scripts/verify/q_j_structure.py
...
## LAW-56 — 2026-09-02 — the P-49 falsifier pinned
direction: strengthen
why: scripts/verify/p49_near_band.py is new gate-covered evidence:
an own Euler-Cromer twisted ring with the full time series at the
rotor's neighbourhood, its own least-squares drive-locked
decomposition, its own direct complex tridiagonal solve for the
tail band (in band and above), the describing-function factor by
series, and the smear identity with its triangle-inequality
tolerance. Cells: N = 48 at gamma 0.5 in an early window for the
smear identity (x_1 rms 0.70, smear 0.784 against 0.780 predicted,
tolerance 0.030); N = 16 at gamma 1 (Omega 1.46, in band) and gamma
0.5 (Omega 3.67) in late windows for the tail law. Mutants
smear-blind (asserts no smear) and band-blind (asserts the in-band
ratio is 1/Omega), each verified failing; at N = 32 the smear was
0.9 percent inside a 1.1 percent tolerance and smear-blind did not
bite, recorded in the docstring. Runtime 10 s. New covered file
requires a fresh pin of the full covered set; nothing else changes
and no gate semantics move.
hashes:
  1b8ab111bb43eb17a25a822468e8f978c4883f67b9ea3b15bc5b85d0b499f7b4  catalog/_common.py
  fb7ed34eb62f641c0a93a98fe0e8a484b61cab8c38a0a76e8c61ea6246468ba9  kernels/__init__.py
  ...
  b9f7d4a0faacf05ffbfd92e07da1fdab2bec7e8a3286342d47ef6cd84acfb9f2  scripts/verify/p47_half_sector.py
  6dd0e268e0816306ff6800cac29169c8159fa43e43a58db13372a05168706cd0  scripts/verify/p48_kappa.py
  96b0d4610c1482d077cf789730df9634cf2d69201751cbabf2c390f8e8580237  scripts/verify/p49_near_band.py
  4355a643f81ab69f9d7f92331355fe37964c445e64873a49b5461c1eefe391e6  scripts/verify/p6_circulant_small.py
  b60ad77d615e353171739472bafbda552f4d1f60f34dd504812c7383a60f7df5  scripts/verify/p7_golden_flux.py
  97bde79c88fc71a1f10af692c7acc4f980a7e97a6f9b1887bf55c5900485a1e5  scripts/verify/q1_saddle_node.py
  9817e5aa93f80e96db3d9429fc778498fd3249f72c1fa17332d21006ff59820f  scripts/verify/q_j_structure.py
...
## LAW-57 — 2026-09-02 — the P-44 falsifier gains a mutant that moves G
direction: strengthen
why: scripts/verify/p44_gramian_chain.py changes on A-27 (R-45a
item 3): its two pinned mutants, sup-blind and mass-blind, both
perturb tau*lambda (tau^2 |lambda|^2 = 0.5625 |lambda|^2 in each)
and were one test. A third, gram-blind, keeps the fixed instance's
lambda and replaces its Gramian by one of correlation 0.999 - not
the Gramian of any S carrying those lambda legitimately - and 2G - P
turns indefinite (-1.33e-2 of |G|); verified failing. Mutant mode
now also checks |T| <= 2 on the extremal instance, so sup-blind is
caught by the bound it violates (2.99940) and not only by the
chain; a non-breaking mutant exits 3 as the later falsifiers do.
Covered set re-pinned; no gate semantics move.
hashes:
  1b8ab111bb43eb17a25a822468e8f978c4883f67b9ea3b15bc5b85d0b499f7b4  catalog/_common.py
  fb7ed34eb62f641c0a93a98fe0e8a484b61cab8c38a0a76e8c61ea6246468ba9  kernels/__init__.py
  02f3a2118b28aeaea0ead99be1cfde6ecd1f6ebdbf08e61cb6c6dc342db02a36  kernels/causet.py
  ...
  ff7d158cc90ea0cabcc6fbfc5f2529eff1078750ff8bd53e7d4db037b10d6ae8  scripts/verify/p42_same_data.py
  36b6b2d4a1a3dff82b291ba06dba557936cd16f0452d377d511f25a5783ba7af  scripts/verify/p43_shadow_body.py
  fc030d65000da28951287e2311f94b10cc8e6a36b083eb2dd45b712dda084db0  scripts/verify/p44_gramian_chain.py
  10e39dbabf2af255358004754f74dbcef3df5eca17aca706326e87e9a84a15b3  scripts/verify/p45_continuity.py
  7dc02c1c2a24e1d06e7de9a3ead7245c13c27f3808b7c4dd14edb75fe1390702  scripts/verify/p46_aftermath.py
  b9f7d4a0faacf05ffbfd92e07da1fdab2bec7e8a3286342d47ef6cd84acfb9f2  scripts/verify/p47_half_sector.py
  6dd0e268e0816306ff6800cac29169c8159fa43e43a58db13372a05168706cd0  scripts/verify/p48_kappa.py
...
## LAW-58 — 2026-09-04 — the P-47 falsifier gains a decorrelated floor cell, combined errors, an inner-probability quench check and a premise mutant
direction: strengthen
why: scripts/verify/p47_half_sector.py changes on A-33 (R-46a): the
LAW-53 falsifier exited 1 on correct physics at seeds 2 and 4 of six,
passed
with the pi bond's coupling cut, and neither pinned mutant moved the
quench check the claim rests on. Four changes, all verified at seeds
4747, 2, 4, 7 and 11 (exit 0 at every seed) and against the mutants
(shift-blind 1, count-blind 1, cut-seam 1, unknown 2): (1) the floor
cell moves from T = 0.2 with a 10-unit gap, where sixty samples were
one trapped state (slip rate about 7e-4 per unit), to T = 0.3 with a
50-unit gap, about one slip per gap, and reads both rings' moments
against the convolution's lattice moments; W^2 >= 1/4 at every twisted
sample stays; (2) the anchor and floor tolerances scale the model SE
by the series' effective sample count (1 + 2 sum rho_k of W^2) and add
the control's error propagated through the curve, the experiment's
SE_combined convention the verifier never carried - seed 2's anchor
had read twisted 0.350 against a prediction of 0.274 from a control
that itself sat 2.3 SE low; (3) the quench check reads the inner
probability P(|W| = 1/2) against the lattice prediction beside the
moment (the moment alone is the identity map at the quench's T_eff,
R-46a): shift-blind now dies there at z 4.4; (4) a premise mutant,
cut-seam, zeroes the twisted bond's coupling, and check (5) requires
the twisted bond's covariant strain variance within a factor 2 of the
other bonds' over the T = 0.5 samples (a cut seam reads 3.56 against
0.77, ratio 4.6). --seed <n> added; the pinned seed stays 4747. L-17
is the rule this entry enforces. Covered set re-pinned; the gate's
semantics strengthen, none move.
hashes:
  1b8ab111bb43eb17a25a822468e8f978c4883f67b9ea3b15bc5b85d0b499f7b4  catalog/_common.py
  fb7ed34eb62f641c0a93a98fe0e8a484b61cab8c38a0a76e8c61ea6246468ba9  kernels/__init__.py
  02f3a2118b28aeaea0ead99be1cfde6ecd1f6ebdbf08e61cb6c6dc342db02a36  kernels/causet.py
  ...
  10e39dbabf2af255358004754f74dbcef3df5eca17aca706326e87e9a84a15b3  scripts/verify/p45_continuity.py
  7dc02c1c2a24e1d06e7de9a3ead7245c13c27f3808b7c4dd14edb75fe1390702  scripts/verify/p46_aftermath.py
  4747de3d03cb4f9e3d160a050da31ec978c49c1dd6c076e75980e28fcc9cec16  scripts/verify/p47_half_sector.py
  6dd0e268e0816306ff6800cac29169c8159fa43e43a58db13372a05168706cd0  scripts/verify/p48_kappa.py
  96b0d4610c1482d077cf789730df9634cf2d69201751cbabf2c390f8e8580237  scripts/verify/p49_near_band.py

## LAW-59 — 2026-09-04 — the P-48 falsifier drops its withdrawn near-band check; the P-49 smear check names its tolerance
direction: strengthen
why: scripts/verify/p48_kappa.py and scripts/verify/p49_near_band.py change
on A-31 and A-32 (R-47b item 5, R-48a item 4). A-31: the P-48
falsifier's check (3) read the offset-2 ratio under the rotor
reference, the clause R-47a withdrew, and the bond-reference ratio
with the (A_1/(2 Omega)) v_slow mixing term, the mechanism R-47a
refuted; at N = 16 neither could see the leakage-assisted agreement
that occurred at N = 64. Removed; the tail law near the band is
carried by the P-49 falsifier (LAW-56), and the claim's coverage line
says so. Checks (1) and (2), the map's homogeneity in kappa, stand
with their mutants (kappa-blind 1, load-blind 1). A-32: the P-49
falsifier's check (1), the smear identity, took the reading's own
remainder phasor as its tolerance and passed on any series (R-48a:
exit 0 on synthetic noise). The tolerance now names its terms - the
slow part of the neighbour's velocity (running mean over one rotor
period of the non-fundamental remainder) leaking through the rotor
reference by its own phasor, plus twice the 2-Omega self floor - and
the harmonic rest is bounded, not absorbed. Correct physics passes
(0.7841 against 0.7796, tolerance 0.0274); smear-blind and band-blind
exit 1; the noise probe now exits 1 (2.5305 against 0.7796, tolerance
0.1605). The wrong-site probe (site b+2's velocity fed as the
neighbour's) still passes, 0.7029 against 0.7796 inside a tolerance of
0.1403, because at site 2 the slow leak is a seventh of the
fundamental - the same leakage R-47a measured at N = 64; that is the
identity holding at another site, not a bypass, and it is recorded.
Covered set re-pinned; the gate's semantics strengthen, none move.
hashes:
  1b8ab111bb43eb17a25a822468e8f978c4883f67b9ea3b15bc5b85d0b499f7b4  catalog/_common.py
  fb7ed34eb62f641c0a93a98fe0e8a484b61cab8c38a0a76e8c61ea6246468ba9  kernels/__init__.py
  02f3a2118b28aeaea0ead99be1cfde6ecd1f6ebdbf08e61cb6c6dc342db02a36  kernels/causet.py
  ...
  7dc02c1c2a24e1d06e7de9a3ead7245c13c27f3808b7c4dd14edb75fe1390702  scripts/verify/p46_aftermath.py
  4747de3d03cb4f9e3d160a050da31ec978c49c1dd6c076e75980e28fcc9cec16  scripts/verify/p47_half_sector.py
  d7622816d4cba69a3daf5b19e830028ea403ebd7e57ebded89930c52878fef45  scripts/verify/p48_kappa.py
  fc338eca8d772eb516e53d9983a13134cafcb46659b79032b7c154f536832dbe  scripts/verify/p49_near_band.py
  4355a643f81ab69f9d7f92331355fe37964c445e64873a49b5461c1eefe391e6  scripts/verify/p6_circulant_small.py
  b60ad77d615e353171739472bafbda552f4d1f60f34dd504812c7383a60f7df5  scripts/verify/p7_golden_flux.py
  97bde79c88fc71a1f10af692c7acc4f980a7e97a6f9b1887bf55c5900485a1e5  scripts/verify/q1_saddle_node.py
  9817e5aa93f80e96db3d9429fc778498fd3249f72c1fa17332d21006ff59820f  scripts/verify/q_j_structure.py
...
## LAW-60 — 2026-09-05 — the P-47 floor cell reads its own temperature and fails a constant series; the P-49 smear tolerance is bounded by the reference and capped
direction: strengthen
why: scripts/verify/p47_half_sector.py and scripts/verify/p49_near_band.py
change on the 2026-09-05 audit of LAW-58 and LAW-59 (R-46c, R-48g,
L-18). p47: (1) LAW-58's floor cell at T = 0.3 slipped 0.2 to 0.5
times per 50-unit gap, not once; the twisted W^2 sat at 0.25 at every
sample of every seed (no power) and one control seed read a constant
series, which passed only because the effective-sample estimator
returns 1 on a constant series and inflated the SE sixty-fold. The
cell moves to T = 0.4 and a constant sampled series now fails
outright. (2) The floor cell read the twisted moment against a
prediction from the control's own noisy temperature estimate; at seed
4747 a two-sigma control fluctuation (0.0833 against 0.1846) made two
legitimate 3/2 samples a four-sigma miss (z 4.13). An equilibrium
cell knows its bath temperature: both rings now read against the
convolution at the nominal T = 0.4 (Ec 0.1846, Et 0.2786), shift-blind
predicting the twisted moment equal to the control's lattice moment.
Seeds 4747, 2, 4, 7, 11, 13, 9: exit 0, twisted z 1.24 / -0.83 /
-0.70 / 0.16 / 1.24 / 2.33 / -0.93, control z -1.99 to 0.89. Mutants:
shift-blind 1 (the quench inner probability), count-blind 1 (the
anchor, and the constant-series check), cut-seam 1 (the premise
check, ratio 4.61, and the T = 0.4 moment at z 4.50). The premise
check's power reaches coupling of about 0.4 (R-46c); A-37 queued.
p49: (3) LAW-59's tolerance still used the slow part's own rotor
phasor and a DC offset inflated it (R-48g: a rotor-locked sinusoid
plus a DC offset of 3 passed). The slow leak is now bounded by a
quantity of the reference alone - the slow part's rms times the
window's mean resultant |<e^{-i theta_b}>| - plus twice the self floor,
and capped: an allowed leak above 5 percent of the fundamental fails
the cell as untestable. scripts/experiments/a32_probes.py (seed 1)
is the repo script L-18 asks for: real passes (0.7841 against 0.7796,
|d| 0.0045, tol 0.0222); the wrong site's velocity fails (|d| 0.0767,
tol 0.0909, slow bound 0.0781 over the cap) - LAW-59's rationalisation
of its pass is withdrawn; noise fails (2.5305, tol 0.1904, bound
0.1776); noise with a trend fails (bound 0.9900); a rotor-locked
sinusoid fails (|d| 0.4984, tol 0.0156); the same plus a DC offset
fails (bound 0.1738). Verifier: exit 0; smear-blind 1; band-blind 1.
Covered set re-pinned; the gate's semantics strengthen, none move.
hashes:
  1b8ab111bb43eb17a25a822468e8f978c4883f67b9ea3b15bc5b85d0b499f7b4  catalog/_common.py
  fb7ed34eb62f641c0a93a98fe0e8a484b61cab8c38a0a76e8c61ea6246468ba9  kernels/__init__.py
  ...
  10e39dbabf2af255358004754f74dbcef3df5eca17aca706326e87e9a84a15b3  scripts/verify/p45_continuity.py
  7dc02c1c2a24e1d06e7de9a3ead7245c13c27f3808b7c4dd14edb75fe1390702  scripts/verify/p46_aftermath.py
  001432e72d0851aafe247d7604de9bf2a933e6b69ec8058d2666fe642bc50df5  scripts/verify/p47_half_sector.py
  d7622816d4cba69a3daf5b19e830028ea403ebd7e57ebded89930c52878fef45  scripts/verify/p48_kappa.py
  c3b2e543ff1103f46b63350b9df909c8ec1471229fb86c36cd1aa818a3de6ad3  scripts/verify/p49_near_band.py
  4355a643f81ab69f9d7f92331355fe37964c445e64873a49b5461c1eefe391e6  scripts/verify/p6_circulant_small.py
  b60ad77d615e353171739472bafbda552f4d1f60f34dd504812c7383a60f7df5  scripts/verify/p7_golden_flux.py
  97bde79c88fc71a1f10af692c7acc4f980a7e97a6f9b1887bf55c5900485a1e5  scripts/verify/q1_saddle_node.py
  9817e5aa93f80e96db3d9429fc778498fd3249f72c1fa17332d21006ff59820f  scripts/verify/q_j_structure.py
