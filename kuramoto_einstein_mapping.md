...
2. **Strong-field regime.** The mapping above works perturbatively (small phase gradients). Near black holes, $r \to 0$, and the perturbative expansion of $C_{ij}$ breaks down. The Feigenbaum cascade (period-doubling toward the stuck singularity) should emerge from the Kuramoto dynamics in the $r \to 0$ limit.
